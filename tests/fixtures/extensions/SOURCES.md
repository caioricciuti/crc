...
|---|---|---|
| `sort-lines/sort_lines.wasm` | crc-extensions `71d4836` (the module unchanged since `aa9604c`), `extensions/sort-lines`, `cargo build --release --target wasm32-unknown-unknown` with Rust 1.98.0 | `7e052ae010e48dd1738b0e47d628e50459fab0af573b9cb3eb16edc0f7f5a449` |
